...
/*
 *  implementing syncronize block and performing synchronization and using wait, notify methods
 */
@SuppressWarnings("InfiniteLoopStatement")
public class InfiniteLoopStatementProcessor {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final InfiniteLoopStatementProcessor processor1 = new InfiniteLoopStatementProcessor();
