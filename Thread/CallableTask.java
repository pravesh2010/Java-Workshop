...
/*
 *  implementing callable interface and performing Task
 */
class Point{
    public int x,y;
...
public class CallableTask implements Callable<Point> {
    String name;
    int x;
    int y;

    public CallableTask (String name, int x, int y) {
        this.name = name;
        this.x = x;
        this.y = y;
    }
...
class TestCallableTask {
    public static void main(String[] args) {
        ...
        for (int counter = 0; counter < 10; counter++) {
            Future<Point> future = service.submit(new CallableTask("Task" + (counter + 1), counter + 1, counter + 2));  //This is Task
