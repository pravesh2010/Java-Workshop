...
public class Three implements Externalizable {
    private int bookId;
    private String isbn;
    ...
    public Three(int bookId, String isbn, String title, String publisher, String author) {
        this.bookId = bookId;
        this.isbn = isbn;
        this.title = title;
    ...
    public static void main(String[] args) throws Exception{
        ...
        Three b1 = new Three(rand.nextInt(100),
