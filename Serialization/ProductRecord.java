...
public class ProductRecord implements Serializable {
    ...
    public ProductRecord(int productCode, String composition, String productName, String company,
                         int stockQuantity, int reorderLevel, float unitPrice) {
    ...
    public void setUnitPrice(float unitPrice) {
     ...
     static class ProductFileStream{
    ...
    public static void main(String[] args) {
        ...
        String filePath = "D://Java//Serialization Path//product.dat";
        List<ProductRecord> list = new ArrayList<>();
